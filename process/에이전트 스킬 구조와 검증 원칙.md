...
- Codex 전역 지침 `~/.codex/AGENTS.md`는 Claude 전역 지침 `~/.claude/CLAUDE.md`에서 import하거나, `~/.claude/CODEX_AGENTS.md`로 복사해 연결한다.
...
- 이관 후 검증 기준은 `~/.claude/CLAUDE.md`, `~/.claude/skills/*/SKILL.md`, 기존 `~/.claude/settings.json` 보존 여부를 확인하는 것이다.
