...
```tsx
import { OBTGroupSelector2, OBTGroupSelector2Props, OBTGroupSelector2Methods } from 'luna-orbit';

export interface OBTGroupSelector2Props {
  /**
...
export interface OBTGroupSelector2Methods {
  /**
   */
  renderItem(list: any, value: any, template: any, defaultTemplate: any, onMapItem: any, onRenderItem: any, mouseOverKey: string, itemKeyProperty: string): any;
