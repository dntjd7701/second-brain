...
```tsx
import { OBTTimePicker2, OBTTimePicker2Props, OBTTimePicker2Methods } from 'luna-orbit';

export interface OBTTimePicker2Props {
  /**
   */
  tooltip?: IOBTTooltip;
  ...
  /**
   */
  ignoreStepsWhenDirectInput?: boolean;

  /**
   */
  useHelpTooltip?: number | boolean;
...
export interface OBTTimePicker2Methods {
  /**
   */
  focus(): void;
