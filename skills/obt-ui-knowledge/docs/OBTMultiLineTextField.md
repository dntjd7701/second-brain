...
```tsx
import { OBTMultiLineTextField, OBTMultiLineTextFieldProps, OBTMultiLineTextFieldMethods } from 'luna-orbit';

export interface OBTMultiLineTextFieldProps {
  /**
   */
  maxLength?: number;
...
export interface OBTMultiLineTextFieldMethods {
  /**
   * 컴포넌트에 포커스를 준다
   */
  ...
  /**
   */
  setCaretPosition(start: any, end: any): void;
