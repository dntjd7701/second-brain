...
```tsx
import { OBTDatePeriodPicker, OBTDatePeriodPickerProps, OBTDatePeriodPickerMethods } from 'luna-orbit';

export interface OBTDatePeriodPickerProps {
  /**
...
export interface OBTDatePeriodPickerMethods {
  /**
   * 컴포넌트에 포커스를 준다
   */
