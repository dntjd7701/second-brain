# OBTYearMonthPeriodPicker

```tsx
import { OBTYearMonthPeriodPicker, OBTYearMonthPeriodPickerProps, OBTYearMonthPeriodPickerMethods } from 'luna-orbit';

export interface OBTYearMonthPeriodPickerProps {
  /**
...
패널의 위치를 지정합니다.
  ...
  /**
   */
  onChange: (e: ChangeEventArgs<Value>) => void;

  /**
   */
  onValidate?: (e: ValidateEventArgs<Value>) => void;
...
export interface OBTYearMonthPeriodPickerMethods {
  /**
   * 컴포넌트에 포커스를 준다
   */
