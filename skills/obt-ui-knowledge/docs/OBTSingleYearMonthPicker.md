# OBTSingleYearMonthPicker

```tsx
import { OBTSingleYearMonthPicker, OBTSingleYearMonthPickerProps, OBTSingleYearMonthPickerMethods } from 'luna-orbit';

export interface OBTSingleYearMonthPickerProps {
  /**
...
export interface OBTSingleYearMonthPickerMethods {
  /**
   * 컴포넌트에 포커스를 준다
   */
