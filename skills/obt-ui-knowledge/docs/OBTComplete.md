...
```tsx
import { OBTComplete, OBTCompleteProps, OBTCompleteMethods } from 'luna-orbit';

export interface OBTCompleteProps {
  /**
   */
  dataInfo: { columnWidths: string[]; itemInfo: { key: string; column: number; isKeyValue?: boolean; }[]; };
...
export interface OBTCompleteMethods {
  /**
   */
  focus(): void;
