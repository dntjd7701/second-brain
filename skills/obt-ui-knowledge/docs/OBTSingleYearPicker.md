...
```tsx
import { OBTSingleYearPicker, OBTSingleYearPickerProps, OBTSingleYearPickerMethods } from 'luna-orbit';

export interface OBTSingleYearPickerProps {
  /**
...
export interface OBTSingleYearPickerMethods {
  /**
   * 컴포넌트에 포커스를 준다
   */
