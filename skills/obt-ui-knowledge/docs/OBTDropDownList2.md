...
```tsx
import { OBTDropDownList2, OBTDropDownList2Props, OBTDropDownList2Methods } from 'luna-orbit';

export interface OBTDropDownList2Props {
  /**
...
export interface OBTDropDownList2Methods {
  /**
   */
  isEmpty(): boolean;
